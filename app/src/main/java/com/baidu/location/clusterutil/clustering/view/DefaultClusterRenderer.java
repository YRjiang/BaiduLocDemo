...
package com.baidu.location.clusterutil.clustering.view;
...
import com.baidu.location.clusterutil.MarkerManager;
import com.baidu.location.clusterutil.clustering.Cluster;
...
import com.baidu.location.clusterutil.projection.Point;
import com.baidu.location.clusterutil.projection.SphericalMercatorProjection;
import com.baidu.location.clusterutil.ui.IconGenerator;
import com.baidu.location.clusterutil.ui.SquareTextView;
...
import static com.baidu.location.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, BaiduMap map, ClusterManager<T> clusterManager) {
        ...
        Log.d("Mytest", "DefaultClusterRenderer: mDensity:" + mDensity);
    ...
    private static Point findClosestCluster(List<Point> markers, Point point) {
        ...
        Log.d("Mytest", "findClosestCluster: zoom: " + MAX_DISTANCE_AT_ZOOM);
