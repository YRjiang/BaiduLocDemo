 ...
 */
package com.baidu.location.clusterutil.clustering;


import com.baidu.location.clusterutil.MarkerManager;
import com.baidu.location.clusterutil.clustering.algo.Algorithm;
import com.baidu.location.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.baidu.location.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.baidu.location.clusterutil.clustering.view.ClusterRenderer;
import com.baidu.location.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements BaiduMap.OnMapStatusChangeListener, BaiduMap.OnMarkerClickListener {
    ...
    public boolean onMarkerClick(Marker marker) {
        return false;
        //return getMarkerManager().onMarkerClick(marker);//yr add
    }
